...
function init() {
  ...
  buttonEl.addEventListener('click', openInfo, false)
...
function addParticles () {
  ...
  
  {
    ...
    const pointSprite = new THREE.TextureLoader().load('../assets/pointImg.png')
...
function addCenterBox () {
  ...
  const boxLogoSprite = new THREE.TextureLoader().load('../assets/logoDark.png')
...
function mouseEnter () {
  ...
  centerBoxMesh.material.map = new THREE.TextureLoader().load('../assets/logoLight.png')
  mainLogoEl.src = './assets/logoLight.png'
}
function mouseLeave () {
  scene.fog.far = 10000
  ...
  centerBoxMesh.material.map = new THREE.TextureLoader().load('../assets/logoDark.png')
  mainLogoEl.src = './assets/logoDark.png'
}
